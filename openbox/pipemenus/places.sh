...
#recent_script="$HOME"/Dropbox/openbox/pipemenus/recent.sh
...
open_file() {
	...
	#[ -x "$1" ] && exec "urxvt -e" "$1"     # uncomment this and comment out previous line to run executables in terminal instead of editing
